...
f2=[0 for i in range(8)]
accur=[0 for i in range(8)]
k=0
...
#epochs=np.array(epochs).reshape(1,5)
j=[]
j1=[]
...
plt.ylabel('F1-MACRO')
plt.legend(xaxis)
plt.savefig(cwds+'/layer-vs-f1(macro)_task2_catdog.png')
plt.show()
plt.clf()
...
plt.ylabel('F1-MACRO')
plt.legend(xaxis)
plt.savefig(cwds+'/layer-vs-f1(macro)part1_task2_catdog.png')
plt.show()
plt.clf()
...
plt.ylabel('F1-MACRO')
plt.legend(xaxis)
plt.savefig(cwds+'/layer-vs-f1(macro)_task2part2_catdog.png')
plt.show()
plt.clf()
...
plt.ylabel('F1-MICRO')
plt.legend(xaxis)
plt.savefig(cwds+'/layer-vs-f1(micro)_task2_catdog.png')
plt.show()
plt.clf()
...
plt.ylabel('F1-MICRO')
plt.legend(xaxis)
plt.savefig(cwds+'/layer-vs-f1(micro)_task2part1_catdog.png')
plt.show()
plt.clf()
...
plt.ylabel('F1-MICRO')
plt.legend(xaxis)
plt.savefig(cwds+'/layer-vs-f1(micro)_task2part2_catdog.png')
plt.show()
plt.clf()
...
plt.ylabel('ACCURACY')
plt.legend(xaxis)
plt.savefig(cwds+'/accuracy(task2)_catdog.png')
plt.show()
plt.clf()
...
plt.ylabel('ACCURACY')
plt.legend(xaxis)
plt.savefig(cwds+'/accuracy(task2)part1_catdog.png')
plt.show()
plt.clf()
...
plt.ylabel('ACCURACY')
plt.legend(xaxis)
plt.savefig(cwds+'/accuracy(task2)part2_catdog.png')
plt.show()
plt.clf()
