...
plt.ylabel('F1-MACRO')
plt.legend(legends)
plt.savefig(cwds+'/layer-vs-f1(macro)_task4_Cat-Dog.png')
plt.show()
plt.clf()
...
plt.ylabel('F1-MICRO')
plt.legend(legends)
plt.savefig(cwds+'/layer-vs-f1(micro)part1_task4_Cat-Dog.png')
plt.show()
plt.clf()
...
plt.ylabel('Accuracy')
plt.legend(legends)
plt.savefig(cwds+'/layer-vs-f1(Acc)_task4_Cat-Dog.png')
plt.show()
plt.clf()
