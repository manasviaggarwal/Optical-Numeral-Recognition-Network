...
plt.ylabel('F1-MACRO')
plt.legend(list5)
plt.savefig(cwds+'/layer-vs-f1(macro)_task3_mnist_2.png')
plt.show()
plt.clf()
...
plt.ylabel('F1-MICRO')
plt.legend(list5)
plt.savefig(cwds+'/layer-vs-f1(micro)part1_task3_mnist_2.png')
plt.show()
plt.clf()
...
plt.ylabel('ACCURACY')
plt.legend(list5)
plt.savefig(cwds+'/accuracy(task3)_mnist_2.png')
plt.show()
plt.clf()
...
plt.savefig(cwds+'/f1(macrotask3_mnist_2.png')
plt.show()
plt.clf()
epochs1=[i for i in range(300)]
...
plt.savefig(cwds+'/micro)part1_task3_mnist_2.png')
plt.show()
plt.clf()
...
plt.savefig(cwds+'/accuracy(task3)_mnisttt_2.png')
plt.show()
plt.clf()
